import { AbstractNode, TemplateElement, _ } from "../../index";
import assert from "assert";

describe("AbstractNode/printChain.spec.ts", () => {

    describe("node.printChain(nodes, ...delimiter[])", () => {
        ...
        it("stringify without delimiter", () => {
            ...
            class Parent extends AbstractNode<{elements: Child[]}> {
                template(): TemplateElement[] {
                    return [
                        "case ",
                        ...this.printChain(this.row.elements),
                        " end"
                    ];
                }
            }
